...
| Мониторинг новых публикаций | 1. Подписаться на RSS-ленты в настройках агента<br>2. Указать тему мониторинга<br>3. Указать способ уведомления (Telegram)<br>4. Получать уведомления о новых статьях |
...
| Генерация дайджестов | 1. Настроить расписание в интерфейсе<br>2. Указать канал для отправки (Telegram)<br>3. Указать получателей<br>4. Получать еженедельный дайджест новых материалов |
| Построение графа знаний | 1. Открыть вики базу в редакторе Obsidian<br>2. Просматривать статьи и вики-страницы в удобном редокторе базы знаний<br>3. Визуализировать граф знаний<br> |
