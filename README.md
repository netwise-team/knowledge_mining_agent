...
[![Version 6.56.2](https://img.shields.io/badge/version-6.56.2-green.svg)](VERSION)
...
Pre-release RC artifacts are published on their tag page, for example [`v6.5.0-rc.4`](https://github.com/razzant/ouroboros/releases/tag/v6.5.0-rc.4); `/releases/latest` intentionally stays on the latest stable release.
...
|---------|------|-------------|
| 6.56.2 | 2026-07-16 | **chore: add pm-github-knowledge-extractor skill to repository.** Copies newly created `pm-github-knowledge-extractor` instruction skill into `skills/` alongside the other PM skills. |
| 6.56.1 | 2026-07-16 | **chore: add PM skills to repository.** Copies `pm-identity`, `pm-research`, `pm-wiki`, and `telegram-bridge` skills into `skills/` so they are available to users who clone the repository. |
